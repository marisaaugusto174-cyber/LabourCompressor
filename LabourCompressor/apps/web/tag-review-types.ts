...
export interface TagReviewItem {
  ...
  readonly tagging: TagReviewTaggingSummary; readonly reviewStatus?: string;
  readonly reviewNote?: string; readonly labelStudioTaskId?: string | number;
}
...
export interface TagReviewTagSummary {
  ...
  readonly evidenceType: string; readonly confidenceScore?: number; readonly evidenceNote: string;
}
...
export interface TagReviewStateItem {
  ...
  readonly labelStudioTaskId?: string | number; readonly status: string; readonly note: string; readonly syncedAt: string;
}
...
export interface ParsedRange {
  ...
  readonly contentLength: number; readonly contentRange?: string;
}
