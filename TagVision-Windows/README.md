...
TagVision V0.1 Windows is a local Web review tool for machine-generated video
...
```text
dist/TagVision-Windows-V0.1.zip
dist/tagvision-windows-0.1.0.tgz
```
...
TagVision V0.1 Windows completes the review loop locally. Select a directory,
